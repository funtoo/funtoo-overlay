...
src_prepare() {
	...
	cd ${S}
	epatch ${FILESDIR}/${PV}/makefile_compat.patch
	epatch ${FILESDIR}/${PV}/lano1106_fglrx_intel_iommu.patch
	epatch ${FILESDIR}/${PV}/lano1106_kcl_agp_13_4.patch
	epatch ${FILESDIR}/${PV}/lano1106_fglrx-13.8_proc.patch
	epatch ${FILESDIR}/${PV}/cold-fglrx-3.14-current_euid.patch
	epatch ${FILESDIR}/${PV}/fglrx_3.17rc6-no_hotplug.patch
	test "${ARCH}" = "x86" && epatch ${FILESDIR}/${PV}/fglrx_gpl_symbol.patch
