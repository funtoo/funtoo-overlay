...
mod_sha["encrypted_session"]="c263975be23a3c195cc7fe170c3a5ca2faa3ef1a"
...
mod_uri["auth_pam"]="https://github.com/${mod_a["auth_pam"]}/${mod_pn["auth_pam"]}/archive/v${mod_sha["auth_pam"]}.tar.gz"
