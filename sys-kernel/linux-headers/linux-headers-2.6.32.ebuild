...
PATCH_VER="1"
SRC_URI="mirror://funtoo/distfiles/gentoo-headers-base-${PV}.tar.lzma"
[[ -n ${PATCH_VER} ]] && SRC_URI="${SRC_URI} mirror://funtoo/distfiles/gentoo-headers-${PV}-${PATCH_VER}.tar.lzma"
